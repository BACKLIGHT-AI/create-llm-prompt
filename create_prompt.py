...
const EXCLUDED_DIRS = new Set(['.git', '.next', 'node_modules', 'dist']);
// Define files that should be skipped.
const EXCLUDED_FILES = new Set(['package.json', 'package-lock.json', 'create_prompt.js', '.DS_Store', 
                                'README.md', 'yarn.lock', 'output.txt']);
